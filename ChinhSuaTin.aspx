<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChinhSuaTin.aspx.cs" Inherits="ChinhSuaTin" %>
...
<body>
                        ...
                        <div class="bg-white border border-top-0 p-4">
                             <form id="form1" method="GET" runat="server">  
                                <div class="form-group">
                                    <label for="message">Hình cũ *</label>
                                    <img class="img-fluid h-100" id="imagetincu" runat="server" style="object-fit: cover;"></img>
                                </div>
                                <div class="form-group">
                                    <label for="message" id="test1" runat="server">Tiêu đề *</label>
    ...
    <div class="container-fluid py-4 px-sm-3 px-md-5" style="background: #111111;">
        <p class="m-0 text-center">  All Rights Reserved. Design by Nhóm 8</p><a id="idnguoidung" runat="server" visible="true"></a><a id="idtin" runat="server" visible="true"></a>
    </div>
    <!-- Footer End -->
