<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConfirmReg.aspx.cs" Inherits="ConfirmReg" %>
    ...
    <div class="container-fluid mt-5 pt-3">
        <div class="container">
            <div class="section-title mb-0">
                <h4 class="m-0 text-uppercase font-weight-bold">Confirmation</h4>
            </div>
            <div class="bg-white border border-top-0 p-4 mb-3">
                <form id="form1" runat="server">
                    <div class="form-group">
                        <asp:Label ID="lbConcodeerror" runat="server" Text="" CssClass="text-danger"></asp:Label>
                        <input type="text" class="form-control p-4" placeholder="Confirmation Code" required="required" id="concode" runat="server" />
                    </div>
                    ...
                    <div>
                        <button class="btn btn-primary font-weight-semi-bold px-4" id="btnSubmit" runat="server" onserverclick="btnSubmit_ServerClick" style="height: 50px;"
                                type="submit">
                            Submit
                        </button>                   
                    </div>
